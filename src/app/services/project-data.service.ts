...
import { ProjectCalculationsService } from './project-calculations.service';
import { WorkbookCacheService } from './workbook-cache.service';
import { DataService } from './data.service';
import { OPTIONAL_FINANCIAL_WORKBOOK } from '../config/pay-app-billing.config';
import { environment, FinancialDataSource } from '../config/environment';
import {
  normalizePayAppBillingData,
  normalizePayAppBillingFromSeed,
  payAppDashboardKpis,
  PayAppBillingSeed,
} from '../utils/pay-app-billing-parser';
import {
  NormalizedBreakdown,
  NormalizedChangeLog,
  NormalizedInvoice,
...
import { computePortfolioMetrics, PortfolioMetrics } from '../utils/financial';
import { collectAllActionItems, ActionItem } from '../utils/action-items';
...
export class ProjectDataService {
  ...
  private async loadBundledSeed(): Promise<void> {
    try {
      const mod = await import('../data/pay-app-billing-seed.json');
