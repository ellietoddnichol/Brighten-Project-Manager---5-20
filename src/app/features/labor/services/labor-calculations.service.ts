...
import { MatchedLaborRate } from '@features/labor/services/labor-rate.service';
import { Project } from '@app/models/types';
import { monthKeyFromDate, isNonUnionEmployee } from '@features/labor/utils/labor-normalizers';
import { isOverheadJobLabel } from '@shared/utils/project';
import {
...
import { suppressLaborExceptionsForOfficeAdmin } from '@features/labor/utils/office-admin-labor';
...
export class LaborCalculationsService {
  ...
  deriveQbLaborActuals(
    projects: Project[],
    monthlyLabor: import('@app/data/project-costs.types').ProjectCostMonthlyLabor[] = [],
  ): QbLaborActual[] {
