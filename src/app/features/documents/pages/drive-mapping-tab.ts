...
import { DRIVE_FOLDER_MAPPING_RULES } from '@app/models/drive-folder-mapping.types';

import { PROJECT_PROFILE_LABELS, PROJECT_PROFILE_OPTIONS } from '@app/models/project-requirements.types';
...
import { DriveFolderDiscoveryService, DiscoveryResult } from '@features/subcontractors/services/drive-folder-discovery.service';

import { DriveService, parseDriveFolderId } from '@core/services/drive.service';
...
import { folderNeedStatusLabel } from '@features/projects/utils/project-requirements.compute';
      ...
      <div class="bg-white rounded-md shadow-sm border border-slate-200 p-5">
        ...
        <div class="flex flex-wrap items-start justify-between gap-4">
          ...
          <div>
            ...
            <h3 class="text-sm font-semibold text-slate-900">Drive Folder Mapping</h3>
