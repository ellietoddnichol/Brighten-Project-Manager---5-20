import { WorkflowView } from '@app/components/project/project-detail.types';
import { CertifiedPayrollWeek } from '@app/models/certified-payroll.types';
import { ChangeRequest, DailyLog, FieldIssue, Rfi, Submittal } from '@app/models/project-controls.types';
import { ChangeOrder, ProjectTask } from '@app/models/types';
import {
  coApprovedAmount,
  coBillingStatus,
  coNumber,
