import {
  ...
  WipWarningChip,
  WipWarningTone,
} from '@app/models/financial.types';
import { Billing, ChangeOrder, Project, ProjectTask } from '@app/models/types';
import { ProjectLifecycleSnapshot } from '@app/models/project-lifecycle.types';
import { isPendingCo, isApprovedUnbilledCo } from '@features/projects/utils/change-management';
import { BRIGHTEN_PROFIT_TARGET } from '@app/config/active-2026-jobs.config';
import { safeDivide } from '@features/projects/utils/project-financial.compute';
import { isClosedProject } from '@shared/utils/project';
