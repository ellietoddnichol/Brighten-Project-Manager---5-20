...
@Component({
  ...
  template: `
    <section id="feature-setup" class="space-y-6">
      <div>
        ...
        <div>
          ...
          <div class="space-y-2">
            @for (entry of group.entries; track entry.id) {
              <div class="flex flex-wrap items-start justify-between gap-3 bg-white rounded-xl border border-slate-200 shadow-sm px-5 py-4">
                <div class="min-w-0 flex-1">
