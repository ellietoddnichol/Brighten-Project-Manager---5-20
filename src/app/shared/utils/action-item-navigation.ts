import { ProjectNavState } from '@app/components/project/project-detail.types';
import { openFinancial, openUtility, openWorkflow } from '@app/components/project/project-navigation';
