...
import { wipConfidenceLabel, wipGroupLabel } from '../utils/wip.compute';
import {
  ...
  wipHubCsvRows,
  WipPageSegmentId,
} from '../utils/wip-hub.compute';
import { WIPRecord } from '../models/financial.types';
...
export class WipPage {
  ...
  compactStats = computed(() => {
    ...
    return [
      ...
      { label: 'Open AR', value: this.fmt(s.openAr), alert: s.openAr > 0 },
