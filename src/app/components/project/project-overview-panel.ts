          ...
          <div class="grid sm:grid-cols-2 gap-3">
            ...
            @for (field of infoFields; track field.key) {
              ...
              <div>
                ...
                <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">{{ field.label }}</div>
        ...
        <section class="bg-slate-50 rounded-xl border border-slate-200 p-4">
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Owner</div>
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">GC / Customer</div>
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Project Manager</div>
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Superintendent / Foreman</div>
        ...
        <section class="bg-slate-50 rounded-xl border border-slate-200 p-4">
          ...
          <div class="grid sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Start Date</div>

              <div class="text-sm text-slate-900 mt-1">{{ date(project.startDate) }}</div>

            </div>

            <div>

              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Projected End</div>

              <div class="text-sm mt-1" [class.text-rose-700]="endDateOverdue()">
            ...
            <div>
              ...
              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Award Date</div>

              <div class="text-sm text-slate-900 mt-1">{{ date(project.awardDate) }}</div>

            </div>

            <div>

              <div class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Current Phase</div>

              <div class="text-sm text-slate-900 mt-1">{{ project.currentPhase || '—' }}</div>
